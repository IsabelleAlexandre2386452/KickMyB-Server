...
class ServiceTaskTests {
    ...
    ServiceAccount.UsernameAlreadyTaken, BadCredentialsException
    {
        ...
        try {
            serviceTask.deleteTask(1L,alice);
        }
        catch (Exception e){}
        alice = serviceTask.userFromUsername("alice");
        assertEquals(0, serviceTask.home(alice.id).size());
    ...
    @Test
    void testDeleteTaskAvecIdInexistant() throws ServiceTask.Empty, ServiceTask.TooShort, ServiceTask.Existing,
            ServiceAccount.UsernameTooShort, ServiceAccount.PasswordTooShort,
            ServiceAccount.UsernameAlreadyTaken, BadCredentialsException
    {
        SignupRequest req = new SignupRequest();
        ...
        try {
            serviceTask.deleteTask(6554L,user);
        }
        catch (Exception e){}
    ...
    @Test
    void testDeleteNotOwnedTask() throws ServiceTask.Empty, ServiceTask.TooShort, ServiceTask.Existing,
            ServiceAccount.UsernameTooShort, ServiceAccount.PasswordTooShort,
            ServiceAccount.UsernameAlreadyTaken, BadCredentialsException
    {
        SignupRequest req = new SignupRequest();
